...
class CreateProviderDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, address: { required: true, type: () => String }, phone: { required: true, type: () => String }, email: { required: false, type: () => String }, company: { required: true, type: () => String }, status: { required: false, type: () => Boolean } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateProviderDto.prototype, "company", void 0);
__decorate([
